...
if(!isset($_COOKIE["last_five"])){
  setcookie("last_five","Notepad++",time()+(86400*30),"/");
}
else{
  $last_five_updated = $_COOKIE["last_five"].','."Notepad++";
...
<!DOCTYPE html>
  ...
  <div class="container" style="margin-top: 20px;">
    <div class="row">
      <div class="col s4">
      <img src="images/product2.png" alt="product1" height="300" width="350">
    </div>
      <div class="col s4 offset-s2">
        <span style="font-size: 12px; color:#358ED7;">TEXT EDITOR</span><br>
        <h4 align="center" style="font-weight: 300; font-size: 40px; color: #43484D; letter-spacing: -2px;">Notepad++</h4>
    ...
    <label class="star star-1" for="star-1"></label>
      ...
      <div class="row">
        ...
        <div class="input-field col s1">
          <input readonly value="2" id="product_id" name="product_id" type="text" class="validate">
...
$review_num = mysqli_query($conn,"SELECT COUNT(*) FROM `review` WHERE product_id=2");
...
$avg_rating = mysqli_query($conn,"SELECT avg(rating) FROM `review` WHERE product_id=2");
...
$sql = "SELECT * FROM `review` WHERE product_id=2";
